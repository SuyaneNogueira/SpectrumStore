...
import TelaRetirada from './telaRetirada/TelaRetirada.jsx'; // ✅ IMPORTAR O COMPONENTE
...
import { RetiradaProvider } from './contexts/RetiradaContext.jsx';

function App() {
  return (
    <Router> {/* ✅ ROUTER PRECISA ESTAR NO TOPO */}
      <FavoriteProvider> 
        <CartProvider>
