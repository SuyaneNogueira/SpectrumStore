...
// =========================================================
// 👇👇👇 PARTE 1: O COMPONENTE MODAL (O Pop-up) 👇👇👇
// (Este componente separado fica no mesmo arquivo, ACIMA do seu Dashboard)
// =========================================================
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          <h2>Editar Peça: {peca.nome_peca} (Posição #{peca.id})</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="modal-footer">
            ...
            <button type="submit" className="btn-salvar">Salvar Mudanças</button>
          </div>
        </form>
      </div>
    </div>
 ...
 // 👇👇👇 PARTE 3: "DINAMINA" (FUNÇÕES DO MODAL) 👇👇👇
  ...
  const handleSavePeca = async (formData) => {
    ...
    try {
      ...
      const res = await fetch(`http://localhost:3001/api/maquina/estoque/${id}`, {
        method: 'PUT',
      ...
      if (!res.ok) {
        ...
        throw new Error(erroData.error || "A máquina (API) recusou a atualização.");
      }
