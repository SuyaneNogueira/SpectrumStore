...
const TermosDeUso = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="termos-overlay">
      <div className="termos-modal">
        <header className="termos-header">
          <h2>📜 Termos de Uso</h2>
          <button onClick={onClose} className="termos-close" aria-label="Fechar">×</button>
        </header>
        ...
        <div className="modal-content">
          ...
          <p className="assinatura">✨ A Spectrum Store acredita em um mundo mais sensível, inclusivo e acolhedor.</p>
        </div>
      </div>
    </div>
  );
