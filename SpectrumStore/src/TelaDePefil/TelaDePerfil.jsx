...
function TelaDePerfil() {
  ...
  const [menuAberto, setMenuAberto] = useState(false); // controle do menu ajustes
          ...
          <div className="menu-container">
            ...
            {menuAberto && (
              <div className="menu-ajustes">
                <h4>Ajustes</h4>
                <button className="ajuste-opcao-editar">Editar Perfil</button>
                <button className="ajuste-opcao-excluir">Excluir Perfil</button>
                <button className="ajuste-opcao-suporte">Suporte</button>
              </div>
            )}
          </div>
        </div>
