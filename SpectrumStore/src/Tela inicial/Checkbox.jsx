...
const Checkbox = ({ isChecked, onClick }) => {
  return (
       <StyledWrapper>
         <div title="Like" className="heart-container">
           <input 
             ...
             className="checkbox" 
             type="checkbox" 
             checked={isChecked} // Usa o prop para o estado
             onChange={onClick} // Usa o prop para o evento de clique
           />
           {/* ... o resto do seu SVG e divs... */}
    ...
    <svg xmlns="http://www.w3.org/2000/svg" height={100} width={100} className="svg-celebrate">
        ...
        <polygon points="80,80 70,70" /> </svg>
    </div>
      </div>
    </StyledWrapper>
  );
...
// ... o seu styled-components permanece inalterado ...
